          ...
          snapshot.documents.forEach((f){
            ...
            if(f.data['late'] != 0){
              if(f.data['late'] < 60){
                ...
                latetime = '${hour.toString().padLeft(2, "0")} Jam ${minutes.toString().padLeft(2, "0")} Menit';
              }
            } else {
              latetime = 'On Time';
            }
            HistoryItem item = new HistoryItem(f.documentID, f.data['shift'], latetime, date.toDate(), start.toDate(), end.toDate());
            setState(() {
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Text(
                                  timeFormat.format(listHistory[index].start) + ' AM',
                                  style: TextStyle(
                                    fontFamily: 'Sans',
                                    fontSize: Theme.of(
                                        context)
                                ...
                                Text(
                                  timeFormat.format(listHistory[index].end) + ' PM',
                                  style: TextStyle(
                                    fontFamily: 'Sans',
                                    fontSize: Theme.of(
                                        context)
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Icon(
                                  Feather.clock,
                                  color: MediaQuery.of(context).platformBrightness == Brightness.light ? Colors.red[400] : Colors.red[300],
                                  size: 15.0,
                                ),
                                SizedBox(width: 5.0,),
                                Text(
                            ...
                            Text(
                              listHistory[index].lates,
                              style: TextStyle(
                                color: MediaQuery.of(context).platformBrightness == Brightness.light ? Colors.green[400] : Colors.green[300],
                                fontSize: Theme.of(context).textTheme.caption.fontSize,
                                fontFamily: 'Sans',
                              ),
                            ),
